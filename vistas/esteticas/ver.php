...
if(isset($_POST['enviar'])){
 $r =$controlador->editar( $_POST['nombre_estetica'],$_POST['id_usuario'], $_POST['eslogan'],$_POST['cliente_a'],
            ...
            <div class="tab" role="tabpanel">
                ...
                <div class="tab-content">
							...
							<option value="0" selected>Selecciona un Usuario</option>
									...
									while($rowa=mysqli_fetch_array($resultadoa)){
										...
										if($rowa["id_usuario"]==$row['id_usuario']){
											echo '<option value="'.$rowa["id_usuario"].'" selected>'.utf8_encode($rowa['nombre_usuario'])."  ".utf8_encode($rowa['apellido_p'])." ".utf8_encode($rowa['apellido_m']).'</option>';										}else echo '<option value="'.$rowa["id_usuario"].'">'.utf8_decode($rowa['nombre_usuario'])." ".utf8_encode($rowa['apellido_p'])." ".utf8_encode($rowa['apellido_m']).'</option>';
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="Section4">
                        ...
                        <p>
                            <div class="form-group">
								<h4> Facebook:</h4><label for="nombre"><input type="text" value="<?php echo $row['facebook']; ?>" name="facebook" id="nombre_estetica" maxlength="50" size="20" required/></label>
							</div>

							<div class="form-group">
								<h4> Twitter:</h4><label for="nombre"><input type="text" value="<?php echo $row['twitter']; ?>" name="twitter" id="eslogan" maxlength="50" 								size="20" required/></label>
							</div>
							<div class="form-group">
							<h4> Instagram:</h4><input type="text" value="<?php echo $row['instagram']; ?>" name="instagram" id="eslogan" maxlength="50" 								size="20" required/></label>
