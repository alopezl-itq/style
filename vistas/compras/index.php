  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="../../principal.php">Inicio</a></li> 
       <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Provedores
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="?cargar=compras&controlador=crear">Nuevo Proveedor</a></li>       
          <li><a href="../../vistas/compras">Proveedores Regisrados</a></li>
          </ul>
      </li>
      <li><a href="../compras/index.php">Regresar</a></li>
