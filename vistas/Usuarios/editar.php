...
if(isset($_POST['enviar'])){
 ...
 $controlador->editar($_GET['id_usuario'],utf8_decode($_POST['nombre_usuario']), utf8_decode($_POST['apellido_p']), utf8_decode($_POST['apellido_m']),$_POST['sexo'],$_POST['fecha_nacimiento'],$_POST['telcasa'],$_POST['telefono'],utf8_decode($_POST['email']),$_POST['id_empresa'],$_POST['id_tipo_usuario'],$_POST['id_municipio'],utf8_decode($_POST['colonia']),utf8_decode($_POST['nombre_calle']),$_POST['no_int'],$_POST['no_ext'],$_POST['cp'],utf8_decode($_POST['usuario']),utf8_decode($_POST['password']));
...
<div class="col-lg-6 col-md-6">
						<div class="form-group">
							<h5><i>Celular:</i></h5><label for="tel"><input type="tel" value="<?php echo $row["telefono"]; ?>"
