...
<br/><br/>
    					...
    					<b>Calle:</b>&nbsp;<?php  echo   utf8_encode($row['nombre_calle']); ?> &nbsp;&nbsp;<b>No. Int:</b>&nbsp;<?php echo  $row['no_int']; ?> &nbsp;&nbsp;<b>No. Ext:</b>&nbsp;<?php echo $row['no_ext']; ?><br/>
 <b>Codigo Postal</b>&nbsp;<?php echo $row['cp']; ?>&nbsp;<b>Ciudad:</b>&nbsp;<?php echo  utf8_encode($row['colonia']); ?> &nbsp;<b>Municipio:</b>&nbsp;<?php echo utf8_encode($row['descripcion_municipios']); ?>&nbsp;<b>Estado:</b>&nbsp;<?php echo utf8_encode($row['descripcion_estados']); ?>
<br/><br/><br/>
