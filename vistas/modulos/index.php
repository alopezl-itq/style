...
$resultado2 = $controlador->empleado($estetica);
?>




<form method="POST" action="moduloadd.php">
...
?>
<?php echo utf8_encode($row[1]); ?> <?php echo "<input type=checkbox value=$row[0] name='modulo[]' >"; ?>
