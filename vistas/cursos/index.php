                        ...
                        <div id="menu-wrapper">
                            <div class="row">
                                <div class="logo-wrapper col-md-2 col-sm-2">
                                    <h1>
                                        <a href="#">Cursos</a><br><?php validarSesion();?>
                                    </h1>
                                </div> <!-- /.logo-wrapper -->
                                <div class="col-md-10 col-sm-10 main-menu text-right">
                                     <ul class="menu-first">
                                    <li><a href="../../principal.php"><b>Inicio</b></a></li>
                                    <li><a href="?cargar=cursos&controlador=inicio"><b>Listar</b></a></li>
                                    <li><a href="?cargar=cursos&controlador=crear"><b>Registrar</b></a></li>
                                    <!--<?php menu(); ?>-->
