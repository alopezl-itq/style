	...
	<dl> <b>Actializar</b><br>
		...
		<dd>
			<?php
				...
				$SQL="SELECT * FROM sexo order by id_sexo"; 
		...
		<br>- O -<br>
		<br><button type="button"  data-toggle="modal" data-target="#ModalSexo">Insertar nuevo registro</button>
		</dd>
		...
		<dd>
			...
			<!-- Trigger/Open The Modal -->
		<br>- O -<br>
		<br><button type="button"  data-toggle="modal" data-target="#ModalCiudades">Insertar nuevo registro</button>
		...
		<dd>
			<?
				...
				//selección de la base de datos con la que vamos a trabajar
				mysql_select_db("style");
				echo '<FORM METHOD="POST" ACTION="estados.php">Ciudades<br>';
				//Creamos la sentencia SQL y la ejecutamos
			...
			<!-- Trigger/Open The Modal -->
		<br>- O -<br>
		<br><button type="button"  data-toggle="modal" data-target="#ModalEstados">Insertar nuevo registro</button>
		...
		<dd>
			...
			<!-- Trigger/Open The Modal -->
		<br>- O -<br>
		<br><button type="button"  data-toggle="modal" data-target="#ModalMunicipios">Insertar nuevo registro</button>
		...
		<dd>
			<?
				...
				//selección de la base de datos con la que vamos a trabajar
				mysql_select_db("style");
				echo '<FORM METHOD="POST" ACTION="tipopago.php">Tipo Pago<br>';
				//Creamos la sentencia SQL y la ejecutamos
			...
			<!-- Trigger/Open The Modal -->
		<br>- O -<br>
		<br><button type="button"  data-toggle="modal" data-target="#ModalTipoPago">Insertar nuevo registro</button>
		...
		<dd>
			<?
				...
				//selección de la base de datos con la que vamos a trabajar
				mysql_select_db("style");
				echo '<FORM METHOD="POST" ACTION="modulo.php">Tipo Pago<br>';
				//Creamos la sentencia SQL y la ejecutamos
			...
			<!-- Trigger/Open The Modal -->
		<br>- O -<br>
		<br><button type="button"  data-toggle="modal" data-target="#ModalModulo">Insertar nuevo registro</button>
		...
		<dd>
			...
			<!-- Trigger/Open The Modal -->
		<br>- O -<br>
		<br><button type="button"  data-toggle="modal" data-target="#ModalEstatus">Insertar nuevo registro</button>
		...
		<dd>
			...
			<!-- Trigger/Open The Modal -->
		<br>- O -<br>
		<br><button type="button"  data-toggle="modal" data-target="#ModalTipoUsuarios">Insertar nuevo registro</button>
		...
		<dd>
			...
			<!-- Trigger/Open The Modal -->
		<br>- O -<br>
		<br><button type="button"  data-toggle="modal" data-target="#ModalTipoRedes">Insertar nuevo registro</button>
		...
		<dd>
			...
			<!-- Trigger/Open The Modal -->
		<br>- O -<br>
		<br><button type="button"  data-toggle="modal" data-target="#ModalProductos">Insertar nuevo registro</button>
		...
		<dd>
			...
			<!-- Trigger/Open The Modal -->
		<br>- O -<br>
		<br><button type="button"  data-toggle="modal" data-target="#ModalEmpresas">Insertar nuevo registro</button>
