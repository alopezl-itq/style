...
public function verempresas(){
	$sql ="Select * FROM empresas e, estatus c where e.id_estatus= c.id_estatus";
	...
	$sql = "";
		...
		public function ver(){
		$_GET['id'];
		$sql = ("SELECT * from empresas e, estatus t, estados s, municipios m where e.id_empresa =".$_GET['id']. " and e.id_estado = s.id_estado and e.id_ciudad = m.id_municipio and e.id_estatus = t.id_estatus");
		...
		public function crear(){
			...
			$sql= "INSERT INTO `empresas` (`id_empresa`, `administrador`, `nombre`, `eslogan`, `imagen`, `cliente_a`, `cliente_b`, `cliente_c`, `cliente_d`, `id_estatus`, `calle`, `no_ext`, `no_int`, `id_estado`,`id_ciudad`) VALUES (NULL, NULL, '$this->nombre', '$this->eslogan', '$this->imagen',
 '$this->cliente_a', '$this->cliente_b', '$this->cliente_c', '$this->cliente_d',  '$this->id_estatus', '$this->calle', '$this->no_ext', '$this->no_int', '$this->id_estado', '1'); ";
			//$this->con->query($sql);
