...
$resul = $this->con->consultaR($sql);
		...
		public function crearventa(){
			...
			$sql= "INSERT INTO `detalle_ventas` (`id_ventas`, `monto`, `fecha`, `id_cliente`, `id_usuario`, `id_empresa`) 
			VALUES (NULL, '$this->id_ventas', '$this->monto', '$this->fecha', '$this->id_cliente', '$this->id_usuario', '$this->id_empresa');";
			$this->con->query($sql);
			return true;
