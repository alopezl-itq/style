...
class Conexion extends MySQLi{
		...
		parent::__construct('localhost','alejan14_style','style16','alejan14_style');//local
...
public function consultaR($sql){
	$sql;
	$consulta = mysqli_query(mysqli_connect('localhost','alejan14_style','style16','alejan14_style'),$sql);
	return $consulta;
	}
