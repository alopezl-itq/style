...
class Controlador{
    ...
    public function crearUsuario( $nombre_usuario, $apellido_p, $apellido_m, $sexo, $fecha_nacimiento, $email, $id_empresa,$id_tipo_usuario, $id_municipio,$usuario,$password){
